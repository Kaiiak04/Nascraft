        ...
        for (Category category : categories) {
            ...
            for (int k = 1; k <= 8; k++) {
                ...
                if (item == null) {
                    ...
                    meta.setLore(Arrays.asList(
                            ChatColor.GRAY + "Initial price: " + LegacyText.LEGACY.serialize(price),
                            ...
                            ChatColor.GRAY + "Support: " + (item.getPrice().getSupport() == 0 ? ChatColor.RED + "DISABLED" : LegacyText.LEGACY.serialize(support)),
                            ChatColor.GRAY + "Resistance: " + (item.getPrice().getResistance() == 0 ? ChatColor.RED + "DISABLED" : LegacyText.LEGACY.serialize(resistance)),
                            " ",
                            ChatColor.GREEN + "§lCLICK TO EDIT"
                    ));
