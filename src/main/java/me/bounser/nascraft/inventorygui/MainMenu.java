...
public class MainMenu implements MenuPage {
    ...
    public void open() {
        ...
        gui = Bukkit.createInventory(null, config.getMainMenuSize(), LegacyText.LEGACY.serialize(title));
        ...
        if (config.getLimitOrdersMenuEnabled()) {
            ...
            gui.setItem(
                    ...
                    MarketMenuManager.getInstance().generateItemStack(
                            ...
                            LegacyText.LEGACY.serialize(limit),
                            lore
                    ));
        }
        ...
        if (config.getPortfolioMarketMenuEnabled()) {
            ...
            gui.setItem(
                    ...
                    MarketMenuManager.getInstance().generateItemStack(
                            ...
                            LegacyText.LEGACY.serialize(portfolio),
                            lore
                    ));
        }
        ...
        if (config.getTrendsEnabled()) {
            ...
            gui.setItem(
                    ...
                    MarketMenuManager.getInstance().generateItemStack(
                            ...
                            LegacyText.LEGACY.serialize(trends),
                            lore
                    ));
        }
            ...
            if (j < categories.size()) {
                ...
                if (config.getSetCategorySegments() && category.getItems().size() < 25) {
                    ...
                    for (Item item : category.getItems()) {
                        ...
                        categoryList.add(LegacyText.LEGACY.serialize(loreSegment).replace("[ALIAS]", item.getFormattedName()));
                    }
                }
